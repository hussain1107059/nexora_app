...
class ExpenditureReportScreen extends StatelessWidget {
  final List<ExpenditureReport> items;

  const ExpenditureReportScreen({super.key, required this.items});
    ...
    return Container(
      ...
      child: const Row(
        children: [
          ...
          Expanded(flex: 3, child: Text('Description', style: TextStyle(fontWeight: FontWeight.bold, color: Color(0xFF19243A)), textAlign: TextAlign.right)),
        ],
      ),
    );
  }

  Widget _buildRow(ExpenditureReport item, bool isLast) {
    return Container(
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            ...
            Expanded(flex: 3, child: Text(item.description, textAlign: TextAlign.right, overflow: TextOverflow.ellipsis)),
          ],
        ),
      ),
    );
