...
class OtherIncomeReportScreen extends StatelessWidget {
  final List<OtherIncomeReport> items;

  const OtherIncomeReportScreen({super.key, required this.items});
    ...
    return Container(
      ...
      child: const Row(
        children: [
          ...
          Expanded(flex: 2, child: Text('Consumer', style: TextStyle(fontWeight: FontWeight.bold, color: Color(0xFF19243A)))),
  ...
  Widget _buildRow(OtherIncomeReport item, bool isLast) {
    return Container(
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            ...
            Expanded(flex: 2, child: Text(item.consumer)),
