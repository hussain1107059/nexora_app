...
class PaymentReportScreen extends StatelessWidget {
  final List<PaymentReport> items;

  const PaymentReportScreen({super.key, required this.items});
  ...
  Widget _buildRow(PaymentReport item, bool isLast) {
    return Container(
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            ...
            Expanded(flex: 2, child: Text(item.transId)),
            ...
            Expanded(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: item.type == 'Receive' ? const Color(0xFFD1FAE5) : const Color(0xFFFEE2E2),
                ...
                child: Text(
                  ...
                  style: TextStyle(
                    ...
                    color: item.type == 'Receive' ? const Color(0xFF065F46) : const Color(0xFF991B1B),
                  ),
